...
export default class Popup {
    ...
    bindEvents() {
        ...
        coordinateInput.addEventListener('input', (e) => this.validateCoordinateInput(e.target));
        coordinateInput.addEventListener('blur', (e) => this.validateCoordinateInput(e.target));
    ...
    handleOk() {
        ...
        try {
            ...
            this.showError(input, this.popup.querySelector('#coordinateError'), error.message);
        }
    }
